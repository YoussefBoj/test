...
.overlay {
    background-color: var(--lightblue);
    background: url("https://i.pinimg.com/564x/cb/a7/0a/cba70a379cc56cfc1523ff4418464948.jpg");
    background-attachment: fixed;
    background-position: center;
    background-repeat: no-repeat;
    background-size: cover;
...
<body>
	...
	<div class="container__form container--signup">
		<form method="POST" action="#" class="form" id="form1">
			...
			<input type="text" name="Prénom" placeholder="Prénom" class="input" />
			<label for="age">Age:</label>
            <input type="number" id="age" name="age" placeholder="Enter your age" class="input" min="0" />
